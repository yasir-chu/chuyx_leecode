...
public class LeetCode912 {
    ...
    public static void main(String[] args) {
        Solution solution = new LeetCode912.Solution();
    ...
    public static void quikSort2(int[] arr, int start, int end){
        if (end <= start){
            return;
        }
     ...
     * @param end 快排尾
     */
    public static int getPartition2(int[] arr, int start, int end){
        int tmp = arr[end];
        int i = start, j = end;
        boolean flag = true;
        while (i < j){
